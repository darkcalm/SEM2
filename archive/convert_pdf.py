#!/usr/bin/env python3
"""
Convert specific PDF file to markdown format.
"""
...
def main():
    ...
    pdf_files = [
        "Ethics in Energy Research and Practice Lecture 2023-04-04-1.pdf",
        "MJ2510 L19 Open Science.pdf",
        "The pivotal role of open source knowledge transfer to achieve universal energy access.pdf"
    ]
    
    for pdf_path in pdf_files:
        output_path = Path(pdf_path).with_suffix('.md')
        # Convert PDF to markdown
        pdf_to_markdown(pdf_path, str(output_path))
